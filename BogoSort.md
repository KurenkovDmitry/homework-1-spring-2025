...
**Дата завершения тестирования:** 23 марта 2025
...
<br/><br/><br/>
### 4.2 Страница своего товара

#### 4.2.1 Доступ к странице товара
...
#### 4.2.2 Взаимодействие с компонентами
...
#### 4.2.3 Визуальные тесты в других браузерах
- **Safari, Firefox, Opera, Microsoft Edge, Yandex:**
  - **Ожидание:** Визуальная и функциональная составляющая идентичны Google Chrome
  - **Результат:** Все браузеры показали одинаковую визуальную и функциональную работу
...
### 4.3 Отчет о тестировании функциональности поиска

#### 4.3.1 Доступ к поиску
- **Местоположение:**
...
##### 4.3.4 Тесты в других браузерах
- **Safari:**
  - **Ожидание:** Визуальная и функциональная составляющая идентичны Google Chrome.
...
### 4.4 Отчет о тестировании оформления заказа

#### 4.4.1 Доступ к оформлению заказа
...
#### 4.4.3 Взаимодейтсвия с компонентами
##### Общее
...
##### 4.4.4 Визуальные тесты в других браузерах
- **Safari, Firefox, Opera, Microsoft Edge, Yandex:**
  - **Ожидание:** Визуальная и функциональная составляющая идентичны Google Chrome.
  - **Результат:** Все браузеры показали одинаковую визуальную и функциональную работу.
...
#### 4.5.1 Доступ к странице заказов
- Переход через хэдер (для авторизованного пользователя):
...
#### 4.5.2 Взаимодействия с компонентами
- **Просмотр заказов**
...
#### 4.5.3 Визуальные тесты в других браузерах
- **Safari, Firefox, Opera, Microsoft Edge, Yandex:**
  - **Ожидание:** Визуальная и функциональная составляющая идентичны Google Chrome.
  - **Результат:** Все браузеры показали одинаковую визуальную и функциональную работу.

### 4.6 Каталог и главная страница
#### 4.6.1 Доступ к каталогу и главной страние
- **Главная страница:**
...
#### 4.6.2 Взаимодействие с компонентами
...
- **Safari, Firefox, Opera, Microsoft Edge, Yandex:**
  - **Ожидание:** Визуальная и функциональная составляющая идентичны Google Chrome.
  - **Результат:** Все браузеры показали одинаковую визуальную и функциональную работу.
### 4.7 Страница чужого товара

#### 4.7.1 Доступ к странице товара
- **Переход с главной страницы:**
  - **Действие:** Клик на карточку товара на главной странице
  - **Ожидание:** Открывается страница выбранного товара
  - **Результат:** Переход работает корректно
...
#### 4.7.3 Визуальные тесты в других браузерах
- **Safari, Firefox, Opera, Microsoft Edge, Yandex:**
  - **Ожидание:** Визуальная и функциональная составляющая идентичны Google Chrome
  - **Результат:** Все браузеры показали одинаковую визуальную и функциональную работу

### 4.8 Тестирование функциональности корзины

#### 4.8.1 Доступ к корзине

- Местоположение:
  - Кнопка корзины является составляющей частью хедера и доступна на всех страницах сайта.
  - Результат: Переход к поиску возможен с любой страницы через хедер.

#### 4.8.2 Функциональность корзины
...
#### 4.9.2 Функциональность избранного
...
| **Раздел 4.2: Страница своего товара**                 | **—**                                                                                                            | **—**                                                                                                                                                                                                                                 | **—**                                                                                                  | **—**                                                                                                              | **—**                                      |    
| **Раздел 4.3: Поиск**                                  | **—**                                                                                                            | **—**                                                                                                                                                                                                                                 | **—**                                                                                                  | **—**                                                                                                              | **—**                                      |
| 4.3-001                                                | Поломалась верстка при возврате к предыдущему запросу                                                            | 1. Ввести запрос `Настольная игр` <br/>2. Нажать на кнопку поиска <br/>3. Ввести запрос `Настольная игра` <br/>4. Нажать на кнопку поиска <br/>5. Нажать на кнопку вернуться                                                          | Видно предыдущий запрос                                                                                | Поломалась верстка                                                                                                 | 🟠 $${\color{darkorange}Средний}$$ (Major) |
| 4.3-002                                                | При уменьшении экрана визуально кнопка пропала, но навестись можно                                               | 1. Уменьшить экран до 1200px                                                                                                                                                                                                          | Кнопка с иконкой поиска либо словом "Поиск", либо отсутствием кнопки вовсе                             | Кнопка есть, пустая                                                                                                | 🟡 $${\color{gold}Низкий}$$ (minor)        |
| 4.3-003                                                | При уменьшении экрана визуал не совпадает с тем, что в браузере Google Chrome (FireFox)                          | 1. Уменьшить экран                                                                                                                                                                                                                    | Совпадает с визуалом в Google Chrome                                                                   | Не совпало                                                                                                         | 🟡 $${\color{gold}Низкий}$$ (minor)        |
| **Раздел 4.4: Оформление заказа**                      | **—**                                                                                                            | **—**                                                                                                                                                                                                                                 | **—**                                                                                                  | **—**                                                                                                              | **—**                                      |
| 4.4-001                                                | Введена длинная строка в поле "ФИО получателя", длина ввода никак не ограничена                                  | 1. Открыть оформление заказа </br> 2. Ввести 250 символов в поле "ФИО получателя" </br> 3. Нажать на кнопку "Оформить заказ"                                                                                                          | Ошибка "Длина ФИО не должна превышать N символов"                                                      | Вернулась ошибка с бэкенда                                                                                         | 🟡 $${\color{gold}Низкий} $$ (Minor)       |
| 4.4-002                                                | Введена длинная строка в поле "Адрес", длина ввода никак не ограничена                                           | 1. Открыть оформление заказа </br> 2. Ввести 250 символов в поле "Адрес" </br> 3. Нажать на кнопку "Оформить заказ"                                                                                                                   | Ошибка "Длина адреса не должна превышать N символов"                                                   | Вернулась ошибка с бэкенда                                                                                         | 🟡 $${\color{gold}Низкий}$$ (Minor)        |
| 4.4-003                                                | При заказе нескольких товаров от одного продавца создается заказ только с одним из товаров                       | 1. Добавить несколько товаров от одного продавца в корзину </br> 2. Оформить заказ                                                                                                                                                    | Создался заказ со всеми товарами                                                                       | Создался заказ только с одним товаром                                                                              | 🔴 $${\color{red}Высокий}$$ (Critical)     |
| **Раздел 4.5: Заказы**                                 | **—**                                                                                                            | **—**                                                                                                                                                                                                                                 | **—**                                                                                                  | **—**                                                                                                              | **—**                                      |
| 4.5-001                                                | Выход номера телефона за границы блока при ширине экрана, меньшей 280px                                          | 1. Открыть страницу заказов </br> 2. Уменьшить широту экрана до 280px                                                                                                                                                                 | Номер телефона не выходит за границы блока                                                             | Номер телефона выходит за границы блока                                                                            | 🟡 $${\color{gold}Низкий} $$    (Minor)    |
| **Раздел 4.6: Каталог и главная страница**             | **—**                                                                                                            | **—**                                                                                                                                                                                                                                 | **—**                                                                                                  | **—**                                                                                                              | **—**                                      |
| **Раздел 4.7: Страница товара (чужая)**                | **—**                                                                                                            | **—**                                                                                                                                                                                                                                 | **—**                                                                                                  | **—**                                                                                                              | **—**                                      |
| **Раздел 4.8: Корзина**                                | **—**                                                                                                            | **—**                                                                                                                                                                                                                                 | **—**                                                                                                  | **—**                                                                                                              | **—**                                      |
| **Раздел 4.9: Избранное**                              | **—**                                                                                                            | **—**                                                                                                                                                                                                                                 | **—**                                                                                                  | **—**                                                                                                              | **—**                                      |

---

## 6. Выводы <a name="выводы"></a>
- Основные функциональности протестированы
- Обнаружены 13 багов, которые необходимо исправить

**Дата составления отчета:** 23.03.2025