...
| 4.5-003| При заказе нескольких товаров от одного продавца создается заказ только с одним из товаров| 1. Добавить несколько товаров от одного продавца в корзину </br> 2. Оформить заказ | Создался заказ со всеми товарами | Создался заказ только с одним товаром| 🔴 $${\color{red}Высокий}$$ (Critical)|
| **Раздел 4.6: Заказы**                                 | **—**                                                                                                                                                                                     | **—**                                                                                                                                                                                                                                 | **—**                                                                                                  | **—**                                                                                                              | **—**                                      |
